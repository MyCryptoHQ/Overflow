...
const INITIAL_STATE: NetworkConfigState = {
  [StaticNetworkIds.ETH]: {
    ...
    tokens: require('balancer/config/tokens/eth.json'),
    contracts: require('balancer/config/contracts/eth.json'),
    dPathFormats: {
  ...
  [StaticNetworkIds.Ropsten]: {
    ...
    tokens: require('balancer/config/tokens/ropsten.json'),
    contracts: require('balancer/config/contracts/ropsten.json'),
    isTestnet: true,
    dPathFormats: {
  ...
  [StaticNetworkIds.Rinkeby]: {
    ...
    tokens: require('balancer/config/tokens/rinkeby.json'),
    contracts: require('balancer/config/contracts/rinkeby.json'),
    isTestnet: true,
    dPathFormats: {
      [SecureWalletName.TREZOR]: ETH_TESTNET,
      [SecureWalletName.LEDGER_NANO_S]: ETH_TESTNET,
  ...
  [StaticNetworkIds.ETC]: {
    ...
    tokens: require('balancer/config/tokens/etc.json'),
    contracts: require('balancer/config/contracts/etc.json'),
    dPathFormats: {
  ...
  [StaticNetworkIds.UBQ]: {
    ...
    tokens: require('balancer/config/tokens/ubq.json'),
    contracts: require('balancer/config/contracts/ubq.json'),
    dPathFormats: {
  ...
  [StaticNetworkIds.EXP]: {
    ...
    tokens: require('balancer/config/tokens/exp.json'),
    contracts: require('balancer/config/contracts/exp.json'),
    dPathFormats: {
